					...
					<div className="col-5 flex-space-evenly">
						...
						>
							<div className="col-12 flex-justify-center">
								<span className="packingParamsTitle">Tiến độ thực hiện: 250 sản phẩm</span>
						...
						>
							<div className="col-12 flex-justify-center">
								<span className="packingParamsTitle">Thời gian đóng gói: {convertHMS(1161)}</span>
								<ProgressBar height="38px" percent={50} />
							</div>
						</div>
						<div
