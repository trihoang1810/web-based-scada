			...
			<div className="row">
				<div className="col-1 col-md-2 col-sm-12">
					{injectionMoldingMachineData ? (
						...
						<Skeleton height={120} baseColor="#999" />
					)}
				</div>
						...
						<>
							<div className="injectionDetail__symbol">
								<svg width="100%" height="100%" viewBox="0 0 270 74" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<path
										d="M79.4699 16.489H97.2792V42.2281H79.4699L73.0586 36.3578V21.682L79.4699 16.489Z"
										fill="white"
									/>
				...
				{injectionMoldingMachineData ? (
					...
					<Skeleton height={350} containerClassName="col-5 col-md-12 col-sm-12" />
				)}
			</div>
